  ...
  return (
    <div className="pt-4">
      ...
      <p className="py-2 text-justify">
        ...
        <div className="badge badge-accent font-mono">/page</div> yang berfungsi
        untuk melaksanakan proses looping. Proses looping dilakukan dengan
        menjadikan jumlah halaman yang diperoleh menjadi batas maksimal nilai.
        Dalam proses looping, kita juga melakukan pengambilan data pada router
        dengan query yang membutuhkan nilai dari nomor page. Berikut contoh
        penulisan kode looping:
      </p>
      <div className="mockup-code md:w-fit xs:max-w-screen-sm pl-5">
        <pre>
          <code className="language-javascript hjls"></code>
        </pre>
      </div>
      <p className="py-2 text-justify">
